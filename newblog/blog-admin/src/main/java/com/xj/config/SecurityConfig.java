...
//                .antMatchers("/user/findAll").hasRole("admin") //访问接口需要admin的角色
                ...
                .antMatchers("/user/**").access("@authService.auth(request,authentication)")
                .antMatchers("/article/**").access("@authService.auth(request,authentication)")
